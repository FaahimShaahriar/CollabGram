...
$query = "SELECT * FROM reg_info WHERE type = 'Influencer'";
                    ...
                    <li> <a href="../controller/logout.php">Logout</a></li>
                        ...
                        <main>
                            <div class="influencer-container">
                                <?php while ($influencerUser = mysqli_fetch_assoc($result)) { ?>
                                    <div class="influencer-card">
                                        <img src="../Assests/profilepicture.png" alt="Profile Picture">
                                        <h3>ID: <?php echo $influencerUser['id'] ?></h3>
                                        <p><strong>Name:</strong> <?php echo $influencerUser['name'] ?></p>
                                        <p><strong>Gender:</strong> <?php echo $influencerUser['gender'] ?></p>
                                        <p><strong>Email:</strong> <?php echo $influencerUser['email'] ?></p>
                                        <p><strong>DOB:</strong> <?php echo $influencerUser['dob'] ?></p>
                                    </div>
                                <?php } ?>
                            </div>
                            </main>
