...
$collaborationsData = getCollaborationData();

// Log errors
if ($collaborationsData === false) {
    error_log("Error retrieving collaboration data.");
}
?>
...
<?php foreach ($collaborationsData as $collaborationData): ?>
    <div>
        <p><?= $collaborationData['Event_Name'] ?> located in <?= $collaborationData['Event_location'] ?> collaborated with <?= $collaborationData['user_name'] ?></p>
    </div>
<?php endforeach; ?>
                                </table>
                            </fieldset>
